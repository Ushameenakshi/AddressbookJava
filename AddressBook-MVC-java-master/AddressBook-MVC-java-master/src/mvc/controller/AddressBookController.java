...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String dept = contactDetailsPanel.getDeptField().getText();
            
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,dept);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setDept(detailPanel.getDeptField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getDeptField().setEditable(false);
        }
    }  //loadPersons ends
